...
2. Run the program
3. Select images by clicking "Browse Images..."
4. Select the "output" directory where you'd want your images exported to
5. Click export button
6. Done, you can find your images in the output directory that you've selected
